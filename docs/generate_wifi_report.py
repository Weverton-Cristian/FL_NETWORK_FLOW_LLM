...
<body>
  ...
  <ul>
    ...
    <li><strong>Legacy-path removal.</strong> The placeholder pair <code>benign_wifi.csv</code> + <code>anomaly_wifi.csv</code> no longer participates in the active Wi-Fi pipeline.</li>
